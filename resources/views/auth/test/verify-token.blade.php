                    ...
                    <div class="card border border-warning" style="border-color:  #8b262c">
                        <div class="card-body p-4">
                            ...
                            <div class="p-2 mt-4">
                                ...
                                @endif
                                <form method="POST" action="{{route('auth.verifyToken')}}">
                                    @csrf

                                    <div class="form-group">
                                        <x-jet-label for="token" value="{{ __('Token') }}" />
                                        <x-jet-input id="token" class="form-control" type="text" name="token" value="{{old('token')}}" required autofocus placeholder="Saisissez le token" />
                                        @error('token')
